# YoloV5-seg NPU
![output image]( https://qengineering.eu/github/YoloV5-seg_Parking_NPU.webp )
## YoloV5 segmentation for RK3566/68/88 NPU (Rock 5, Orange Pi 5, Radxa Zero 3). <br/>
...
$ mkdir *MyDir* <br/>
$ cd *MyDir* <br/>
$ git clone https://github.com/Qengineering/YoloV5-seg-NPU.git <br/>
```
...
![output image]( https://qengineering.eu/github/YoloV5-seg_Bus_NPU.webp )
